...
from fake_stake.base_test import articash_FakeStakeTest

class zARTIValidCoinSpendTest(articash_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zARTIs..." % DENOM_TO_USE)
