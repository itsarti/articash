Contributing to articash Core
============================

The articash Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/articash-project/articash/blob/master/doc/translation_process.md)
...
The following applies to code changes to the articash Core project, and is not to be
confused with overall articash Network Protocol consensus changes.

Whether a pull request is merged into articash Core rests with the project merge
...
Patches that change articash consensus rules are considerably more involved than
...
Where a patchset proposes to change the articash consensus, it must have been
...
The project leader is the release manager for each articash Core release.
