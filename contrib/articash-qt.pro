...
RESOURCES += src/qt/articash.qrc src/qt/articash_locale.qrc

TRANSLATIONS += src/qt/locale/articash_bg.ts \
                src/qt/locale/articash_de.ts \
                src/qt/locale/articash_en.ts \
                src/qt/locale/articash_es.ts \
                src/qt/locale/articash_fi.ts \
                src/qt/locale/articash_fr.ts \
                src/qt/locale/articash_it.ts \
                src/qt/locale/articash_ja.ts \
                src/qt/locale/articash_pl.ts \
                src/qt/locale/articash_pt.ts \
                src/qt/locale/articash_ru.ts \
                src/qt/locale/articash_sk.ts \
                src/qt/locale/articash_sv.ts \
                src/qt/locale/articash_vi.ts \
                src/qt/locale/articash_zh_CN.ts \
                src/qt/locale/articash_zh_TW.ts
