                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzARTIPathCustom = GetArg("-zartibackuppath", "");
    ...
    if(!strzARTIPathCustom.empty()) {
        ui->wallet_customzartibackuppath->setText(QString::fromStdString(strzARTIPathCustom));
        ui->wallet_customzartibackuppath_label->setVisible(true);
        ui->wallet_customzartibackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzARTIPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the articash RPC console.") + "<br>" +
