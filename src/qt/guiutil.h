...
/** Utility functions used by the articash Qt UI.
 */
namespace GUIUtil
{
...
// Render articash addresses in monospace font
...
// Parse "articash:" URI into recipient object, return true on successful parsing
