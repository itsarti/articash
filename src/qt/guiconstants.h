...
/* articash GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "articash"
#define QAPP_ORG_DOMAIN "articash.org"
#define QAPP_APP_NAME_DEFAULT "articash-Qt"
#define QAPP_APP_NAME_TESTNET "articash-Qt-testnet"
