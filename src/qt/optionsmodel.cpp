...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::ARTI);
...
// Wallet
    ...
    if (settings.contains("nAnonymizearticashAmount"))
        SoftSetArg("-anonymizearticashamount", settings.value("nAnonymizearticashAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in articash.cpp during shotdown to also remove the window positions
