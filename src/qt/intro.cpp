...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("articash Core"),
     ...
     * override -datadir in the articash.conf file in the default data directory
     * (to be consistent with articashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
