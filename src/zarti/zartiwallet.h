...
#ifndef articash_ZARTIWALLET_H
#define articash_ZARTIWALLET_H
...
public:
    CzARTIWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZARTI(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZARTI(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
