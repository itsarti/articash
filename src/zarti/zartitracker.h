...
#ifndef articash_ZARTITRACKER_H
#define articash_ZARTITRACKER_H
...
public:
    CzARTITracker(std::string strWalletFile);
    ~CzARTITracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzARTIWallet* zARTIWallet = NULL);
