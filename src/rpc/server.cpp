...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop articash server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "articash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* articash features */
        {"articash", "listmasternodes", &listmasternodes, true, true, false},
        {"articash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"articash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"articash", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"articash", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"articash", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"articash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"articash", "masternodedebug", &masternodedebug, true, true, false},
        {"articash", "startmasternode", &startmasternode, true, true, false},
        {"articash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"articash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"articash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"articash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"articash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"articash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"articash", "preparebudget", &preparebudget, true, true, false},
        {"articash", "submitbudget", &submitbudget, true, true, false},
        {"articash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"articash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"articash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"articash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"articash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"articash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"articash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"articash", "checkbudgets", &checkbudgets, true, true, false},
        {"articash", "mnsync", &mnsync, true, true, false},
        {"articash", "spork", &spork, true, true, false},
        {"articash", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzartiseed", &getzartiseed, false, false, true},
        {"zerocoin", "setzartiseed", &setzartiseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzarti", &searchdzarti, false, false, true},
        {"zerocoin", "dzartistate", &dzartistate, false, false, true},
...
{
    return "> articash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12691/\n";
}
