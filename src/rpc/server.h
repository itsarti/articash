...
/**
 * articash RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZartiSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzartiseed(const UniValue& params, bool fHelp);
extern UniValue getzartiseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzarti(const UniValue& params, bool fHelp);
extern UniValue dzartistate(const UniValue& params, bool fHelp);
